    ...
    <main>
      <div className="flex justify-center w-full px-2 lg:px-12 py-48">
        <form className="flex flex-col items-center w-full max-w-xl shadow-lg bg-white rounded-lg">
            <p className="text-center text-orange-300 font-bold  text-lg">Login To My Account</p>
          ...
          <button className="p-3 px-6 bg-orange-300 text-white text-sm w-fit inline-block border-none outline-none">
            Login
          </button>
          <p className="text-gray-600 text-sm text-left py-8">Dont have an account? <Link className="text-orange-300 underline" href={"/signup"}>Create one Here</Link></p>
        </form>
      </div>
    </main>
  );
